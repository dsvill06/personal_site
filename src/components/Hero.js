          ...
          <div class="relative flex h-screen w-full items-center justify-center">
            ...
            <div className="z-10 max-w-screen-lg  px-4">
              <div className="flex flex-col items-center gap-y-6 text-center backdrop-blur-sm rounded-xl bg-gray-800/40 shadow-lg bg-opacity-30 p-6">
                <h1 className="ps-2 text-4xl font-bold tracking-tight text-white sm:text-7xl">
                  I'm David Villavicencio.
                </h1>
                <p className="text-xl leading-8 text-gray-300">
                  I'm a North Carolina based
                  <strong class="text-white"> Full Stack Software Engineer </strong>
                  currently studying
                  Computer Science at the University of North Carolina at Chapel
                  Hill.
                </p>
                <p className=" text-xl leading-8 text-gray-300">
                  In my free time time, you can catch me reading, playing
                  guitar, or exploring new ideas.
                </p>
                <div className=" flex flex-row gap-x-6 justify-center sm:items-stretch sm:justify-center">
                  <div className=""></div>
                  <a href="https://github.com/dsvill06" rel="noreferrer" target="_blank" className="hoverButton">
                    <FontAwesomeIcon
                      className="text-4xl"
                      icon={faGithub}
                    />
