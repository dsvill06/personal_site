...
import { Navigation } from "../utils/enum.js";
...
export default function Navbar() {
  ...
  return (
    <Disclosure
      as="nav"
      className="w-full fixed z-50 bg-black bg-opacity-40 backdrop-blur-sm"
    >
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          ...
                          "px-3 py-2 text-lg font-medium transition-all duration-300 hover:cursor-pointer"
                        )}
